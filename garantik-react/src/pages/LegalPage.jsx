  ...
  cgu: {
    ...
    sections: [
      ...
      },
      {
        ...
        content: `Le plan gratuit permet de stocker jusqu'à 10 garanties et offre des alertes d'expiration à échéance fixe. Le plan premium, souscrit par abonnement mensuel ou annuel, supprime cette limite et offre des fonctionnalités avancées. Les tarifs en vigueur sont affichés dans l'application.`
      },
      {
  ...
  confidentialite: {
    ...
    sections: [
      ...
      },
      {
        ...
        content: `Vos données de compte sont conservées pendant toute la durée de votre abonnement et jusqu'à 30 jours après la suppression de votre compte. Les données de facturation sont conservées 10 ans conformément aux obligations légales. Les documents que vous déposez sont conservés tant que votre compte est actif.`
      },
      {
