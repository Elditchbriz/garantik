...
• Hey Did+ sans stockage personnel connecté : vos fichiers sont conservés sur l'hébergement sécurisé de Hey Did pendant toute la durée de votre abonnement actif, sans limite de 30 jours.
...
Vous pouvez changer d'option de stockage à tout moment depuis les paramètres de votre compte.`
  ...
  cgu: {
    ...
    sections: [
      ...
      {
        heading: "4. Plan gratuit et Hey Did+",
        content: `Le plan gratuit permet de stocker jusqu'à 10 garanties et offre des alertes d'expiration à échéance fixe. En plan gratuit, les fichiers numérisés (tickets de caisse, contrats, factures) sont analysés par intelligence artificielle puis conservés 30 jours avant suppression automatique et définitive. Seules les données extraites (nom du produit, montant, date, durée de garantie) sont conservées au-delà de cette période. Pour un stockage permanent des fichiers, l'utilisateur doit souscrire à Hey Did+ ou connecter un espace de stockage personnel (Google Drive). Hey Did+, souscrit par abonnement mensuel ou annuel, supprime cette limite et offre des fonctionnalités avancées. Les tarifs en vigueur sont affichés dans l'application.`
      },
      {
      ...
      },
      {
        ...
        content: `L'utilisateur peut supprimer son compte à tout moment depuis la page Mon compte. Les données sont conservées 30 jours après la suppression avant suppression définitive. En cas de non-paiement de l'abonnement Hey Did+, le compte est automatiquement rétrogradé au plan gratuit.`
      },
      {
...
- Hey Did+ (stockage inclus) : les fichiers sont conservés pendant toute la durée de votre abonnement actif.
