  ...
  return (
    <>
        ...
        <div className="lp-hero-inner">
          <div>
            ...
            <div style={{
              ...
              Rejoignez 500+ foyers qui ne ratent plus jamais une échéance
            </div>
          </div>
      ...
      <section className="lp-section tight lp-bg-soft" style={{ borderRadius: 'var(--radius-l)', maxWidth: 1200 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 20, maxWidth: 900, margin: '0 auto 32px' }}>
        ...
        <p style={{ textAlign: 'center', fontSize: 11.5, color: 'var(--ink-faint)', marginTop: 20 }}>
          Ce don n'ouvre pas droit à une réduction fiscale pour vous — c'est Garantik qui le prend en charge sur sa marge.
        </p>
      </section>
