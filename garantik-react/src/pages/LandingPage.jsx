          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13.5 }}>
            <thead>
              <tr style={{ background: 'var(--bg)' }}>
                <th style={{ textAlign: 'left', padding: '14px 18px', fontSize: 12.5, color: 'var(--ink-faint)', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.04em' }}>
                  Fonctionnalité
                </th>
                <th style={{ textAlign: 'center', padding: '14px 18px', fontSize: 13, color: 'var(--ink-soft)', fontWeight: 700 }}>
                  Gratuit
                </th>
                <th style={{ textAlign: 'center', padding: '14px 18px', fontSize: 13, color: 'var(--blue-dark)', fontWeight: 700 }}>
                  Premium
                </th>
              </tr>
            </thead>
            <tbody>
              {COMPARISON_ROWS.map((row) => (
                <tr key={row.label} style={{ borderTop: '1px solid var(--line)' }}>
                  <td style={{ padding: '13px 18px', color: 'var(--navy)', fontWeight: 600 }}>{row.label}</td>
                  <td style={{ padding: '13px 18px', textAlign: 'center' }}><ComparisonCell value={row.free} /></td>
                  <td style={{ padding: '13px 18px', textAlign: 'center' }}><ComparisonCell value={row.premium} /></td>
                </tr>
              ))}
            </tbody>
          </table>
