  ...
  return (
    <>
      ...
      <section className="lp-section tight lp-bg-soft" style={{ borderRadius: 'var(--radius-l)', maxWidth: 1200 }}>
        <div className="lp-section-head">
          <div className="eyebrow-sm">Un premium qui a du sens</div>
          <h2>Votre abonnement soutient une association</h2>
          <p>En passant premium, vous ne protégez pas que vos achats — vous aidez aussi une cause qui vous tient à cœur.</p>
        </div>
        ...
        <div className="lp-feature-grid" style={{ maxWidth: 900, margin: '0 auto 32px' }}>
          <div className="lp-feature-card" style={{ textAlign: 'center' }}>
            ...
            <p style={{ fontSize: 13 }}>Lors de votre passage au premium, sélectionnez l'association qui vous tient à cœur parmi celles proposées.</p>
          </div>
          <div className="lp-feature-card" style={{ textAlign: 'center' }}>
