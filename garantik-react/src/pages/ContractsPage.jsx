  ...
  return (
    <>
      <PageHeader
        ...
        actions={[{ label: 'Nouveau contrat', icon: 'plus', to: '/add-contract' }]}
      />

          <h1 style={{ color: '#fff' }}>Vos échéances</h1>
          <p className="sub">Garanties et contrats à surveiller</p>
        </div>
        <button className="btn btn-primary" onClick={() => navigate('/add-contract')}>
