    ...
    <>
      <PageHeader
        ...
        subtitle={expiringSoonCount > 0
          ? `${expiringSoonCount} échéance${expiringSoonCount > 1 ? 's' : ''} à surveiller dans les 60 prochains jours`
          : 'Tout est à jour — aucune échéance imminente'}
        onSearchClick={openQuickSearch}
        alertCount={alertCount}
        actions={[
          { label: 'Nouvel achat', icon: 'plus', to: '/add-purchase' },
          { label: 'Contrat', icon: 'shield-check', to: '/add-contract', variant: 'secondary' },
        ]}
      />
