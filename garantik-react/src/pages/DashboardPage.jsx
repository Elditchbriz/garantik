      ...
      <div className="dash-stats">
        {(() => {
          ...
          const cards = [
            ...
            {
              key: 'contrats',
              label: expiringContrats > 0 ? 'à renouveler' : 'Contrats',
              num: expiringContrats > 0 ? expiringContrats : contratsCount,
              icon: expiringContrats > 0 ? 'alert-triangle' : 'file-text',
              color: expiringContrats > 0 ? 'amber' : 'green',
              flag: expiringContrats > 0 ? `${contratsCount} contrats au total` : (contratsCount > 0 ? 'Tous actifs' : null),
              flagColor: 'var(--ink-soft)',
              onClick: () => {
            ...
            {
              key: 'abonnements',
              label: expiringAbonnements > 0 ? 'à renouveler' : 'Abonnements',
              num: expiringAbonnements > 0 ? expiringAbonnements : abonnementsCount,
              icon: expiringAbonnements > 0 ? 'alert-triangle' : 'repeat',
              color: expiringAbonnements > 0 ? 'amber' : 'amber',
              flag: expiringAbonnements > 0 ? `${abonnementsCount} abonnements au total` : (abonnementsCount > 0 ? 'Tous actifs' : null),
              flagColor: 'var(--ink-soft)',
              onClick: () => {
