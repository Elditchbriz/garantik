  ...
  return (
    <>
      <div className="topbar">
        <div>
          <div className="eyebrow">Coffre documents</div>
          <h1 style={{ color: '#fff' }}>Mes documents</h1>
          <p className="sub">{docs.length} document{docs.length !== 1 ? 's' : ''} stocké{docs.length !== 1 ? 's' : ''}</p>
        </div>
      </div>
