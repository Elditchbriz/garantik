...
export default function AddPurchasePage() {
  ...
  // Pré-remplissage depuis le résultat du scanner
    ...
    <>
      ...
      <div className="panel">
        <div className="panel-body" style={{ padding: 24 }}>
          ...
          {/* Bouton scanner en haut du formulaire */}
          <button
            type="button"
            className="btn btn-secondary"
            style={{ width: '100%', justifyContent: 'center', marginBottom: 24, gap: 10 }}
            onClick={() => setShowScanner(true)}
          >
            <Icon name="scan" />
            {scanned ? 'Scanner un autre ticket' : 'Scanner un ticket de caisse'}
          </button>
            ...
            <div className="form-grid">
              <div className="field full">
                ...
                <input
                  ...
                  placeholder="Ex : Lave-linge séchant"
                  required
                />
              </div>
