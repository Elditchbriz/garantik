    ...
    <>
      ...
      <div className="page-header" style={{ marginBottom: 16, flexWrap: 'wrap', gap: 10 }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <h1 className="page-header-title" style={{ fontSize: 17 }}>{purchase.object_name}</h1>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          {purchase.total_amount && (
            <span style={{ fontSize: 13, color: 'rgba(255,255,255,0.8)', fontWeight: 600 }}>{purchase.total_amount} €</span>
          )}
        </div>
      </div>
