...
export default function AddContractPage() {
  ...
  function handleScannerClose() {
    // Comme pour les garanties : fermer sans scanner ramène au dashboard.
    navigate('/dashboard');
  }
  ...
  return (
    <>
      ...
      {/* Formulaire (affiché après scan ou choix manuel) — même parcours
          que les garanties, pour ne plus dérouter personne. */}
      {showForm && (
        <div className="panel">
          <div className="panel-body" style={{ padding: 24 }}>
            ...
            {scanned && (
              <div style={{
                ...
                Formulaire pré-rempli depuis le contrat — vérifiez et complétez si nécessaire
              </div>
            )}
          ...
          <div className="modal-card" style={{ maxWidth: 400 }}>
            ...
            <div className="modal-body">
              <p style={{ fontSize: 13.5, color: 'var(--ink-soft)', marginBottom: 20, lineHeight: 1.6 }}>
                ...
                Passez à Hey Did+ pour un accès illimité.
              </p>
