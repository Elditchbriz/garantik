...
export default function ContractScannerModal({ onResult, onClose, onManual }) {
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              ...
              {onManual && (
                <button type="button" onClick={onManual}
                  style={{ background: 'none', border: 'none', color: 'var(--ink-soft)', fontSize: 13, textAlign: 'center', cursor: 'pointer', textDecoration: 'underline', fontFamily: 'inherit', padding: '4px 0' }}>
