...
export default function ScannerModal({ onResult, onClose, onManual, isPremium = false }) {
              ...
              {!isPremium && (
                <div style={{
                  ...
                  <span>
                    ...
                    Pour le conserver définitivement, <a href="/settings#stockage" style={{ color: 'var(--blue)' }}>connectez un espace de stockage</a> ou passez en premium.
                  </span>
                </div>
              )}
