...
// Le bouton d'aide ("?") vit désormais uniquement dans le bandeau global
// (App.jsx) — showHelp est conservé pour compatibilité mais ne fait plus
// rien, afin de ne pas casser les appels existants qui passent ce prop.
  ...
  return (
    <div className="ph">
      ...
      <div className="ph-right">
        ...
        {/* HelpMenu retiré d'ici — vit désormais uniquement dans le bandeau global */}
        {showBell && (
          <button
