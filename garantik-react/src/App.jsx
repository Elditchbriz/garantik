...
export default function App() {
  ...
  const sidebarItems = [
    ...
    { section: 'Compte', items: [
      ...
      { to: '/settings', icon: 'settings', label: 'Paramètres', dupBottomNav: true },
    ]},
  ];
    ...
    <div className={`shell ${collapsed ? 'collapsed' : ''} ${mobileOpen ? 'mobile-open' : ''}`} id="shell">
      ...
      <div className="mobile-topbar">
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <Link to="/faq" className="mobile-help-btn" aria-label="Aide" title="Aide">
            ?
          </Link>
      ...
      <aside className="sidebar">
        ...
        <div className="sidebar-logo">
          <div className="mark"></div>
          <div className="word">Garantik</div>
          <Link to="/faq" className="sidebar-help-btn" aria-label="Aide" title="Aide">
            ?
          </Link>
        </div>
